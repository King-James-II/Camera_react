...
import { pageStyle } from "./styles"; // Import CSS styles
...
// Define the ShutterSpeed component
const ShutterSpeed = () => {
  return (
    <div>
      <h3>Shutter Speed</h3>
...
export { Home, Aperture, ShutterSpeed, ISO }; // Export the components
